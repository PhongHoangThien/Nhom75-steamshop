...
const Cart = () => {
    ...
    return (
        <div className="bg-panelLight min-h-screen py-8 px-4 md:px-16 lg:px-24">
                                ...
                                <div key={product.id} className="grid grid-cols-12 items-center gap-4 border-b py-4 text-sm text-text">
                                    ...
                                    <div className="col-span-2 flex justify-center">
                                        <div className="flex items-center border rounded">
                                            <button className="px-2 hover:bg-panelLight">-</button>
                            ...
                            <div className="rounded-xl text-text shadow p-6 sticky top-24">
                                ...
                                <div className="mt-5 mb-2 relative flex-1">
                                    <input
                                        ...
                                        className="w-full text-bg border rounded-md px-3 py-2 placeholder:pl-2"
                                    />
                                    <button className="absolute right-0 p-3 flex items-center top-0 h-full btn-theme border border-border rounded-r-md">
                                        Áp dụng
                                    </button>
                                </div>

                                <button className="w-full mt-5 btn-theme py-3 rounded-lg font-semibold">
                                    Thanh toán
                                </button>
                                <button className="w-full mt-5 btn-theme py-3 rounded-lg font-semibold">
                                    Tiếp tục mua hàng
